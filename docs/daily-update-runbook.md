...
| Field | Value |
|-------|-------|
| **Last updated** | 2026-08-11 (D160) |
| **Crisis level** | 4 - High (Aug 11: President Trump said the US will seek compensation from Iran for '50 years' of alleged damages, including deaths from 'roadside bombs and many conflicts,' after Tehran tied Hormuz reopening to US-paid war reparations and sanctions relief (Al Jazeera, Aug 11). Trump also said the US Navy has swept the Strait of Hormuz of mines and now holds '100%' control of the waterway, a claim maritime tracking data does not fully support (CNBC, Aug 11). Iran and Oman have agreed on coordinates for a temporary Hormuz shipping route - a northern lane through Iranian waters, a southern lane through Omani waters - with Iranian FM spokesman Baghaei calling talks 'progressing smoothly and constructively,' though Tehran still ties full reopening to an end to the US naval blockade. MarineTraffic data show Hormuz crossings falling from 15 on Friday to 11 Saturday to just 6 on Sunday (Al Jazeera, Aug 11). Brent is $88.05, WTI $82.49 and TTF 61.92 EUR/MWh on Aug 11. Crisis level remains 4 (High); tail raised to 35% while base falls to 10%.) |
| **Brent** | $88.05 (2026-08-11, Trading Economics; +0.4%) |
| **JKM** | $22.00/MMBtu (Jul 24, Reuters Sept-delivery assessment, carried; CFD reference $21.26/MMBtu, Trading Economics, Aug 10; Qatar force majeure carried to mid-September, further extension to mid-October reportedly in preparation) |
| **TTF** | 61.92 EUR/MWh (2026-08-11, Trading Economics; +1.9%) |
| **Exposure trace** | Al Jazeera (Aug 11, citing MarineTraffic) reports Hormuz crossings falling from 15 on Friday (Aug 7) to 11 Saturday (Aug 8) to 6 Sunday (Aug 9), with 17 vessels routed via the Iran-designated lane and 10 classified undetermined. Iran and Oman have agreed coordinates for a temporary Hormuz shipping route, but Iran ties full reopening to an end to the US naval blockade and sanctions relief (Al Jazeera, Aug 11). President Trump said the US will seek reparations from Iran for '50 years' of alleged damages and claimed the US Navy has cleared Hormuz of mines and holds '100%' control of the waterway (CNBC/Al Jazeera, Aug 11). Qatar force majeure remains carried through mid-September, current route-normalised freight and war-risk costs remain unavailable, and no signed reopening is confirmed. |
...
- **Brent**: Pre-shock ~$65 -> $126 wartime high intraday (Day 59, Apr 30, CNBC/CNN) -> $84.35 (Aug 10 early session, Trading Economics) -> rallied ~4.6% intraday Aug 10 to ~$87-88 on Trump's demand for '50 years' of reparations from Iran (gcaptain, Aug 10) -> $88.05 (Aug 11, +0.4%, Trading Economics) as Trump also claimed '100%' US Navy control of Hormuz and MarineTraffic showed weekend crossings collapsing from 15 to 6. Working range $75-85 base (signed workable deal); $78-95 stress (conditional routing); $105-135+ tail (renewed closure).
- **JKM LNG**: Baseline $9.5 -> $23.40/MMBtu (Day 20, Reuters/Platts) -> $22.00/MMBtu (Jul 24, Reuters September-delivery assessment) as sustained Hormuz disruption tightened Asian LNG balances; carried at $22.00 pending a newer weekly assessment. Contextual CFD reference $21.26/MMBtu (Trading Economics, Aug 10, +0.7%). Qatar force majeure is carried through mid-September from the Reuters Jul 23 notice; the reported mid-October extension remains unconfirmed.
- **TTF Gas**: Pre-shock ~$34/MWh -> 63.58/MWh (Jul 24, +2.71% vs Jul 23, MacroMicro) -> 56.34 EUR/MWh (Aug 10 early session, Trading Economics) -> 61.92 EUR/MWh (Aug 11, +1.9%, Trading Economics) as Trump's reparations demand and MarineTraffic's report of collapsing Hormuz crossings (15 to 6 over the weekend) widened the standoff. The marker remains elevated versus the pre-crisis baseline while Qatar LNG force majeure and constrained Hormuz traffic persist.
- **Credit**: iTraxx Asia IG est. ~138bp (Aug 5, -2bp); ASEAN HY est. ~475bp (-8bp), both carried pending fresher EM credit data. The scenario split is now base 10%, stress 55%, tail 35% because Trump demanded reparations from Iran and claimed full US Navy control of Hormuz while MarineTraffic data showed weekend crossings collapsing to just 6; no signed reopening is confirmed.
