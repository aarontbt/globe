...
| Field | Value |
|-------|-------|
| **Last updated** | 2026-09-21 (D201) |
| **Crisis level** | 4 - High (Sep 21: Reuters reported Saudi exports recovered to just over 4 million bpd in September from 2.4 million bpd in August, with Saudi oil moving through Hormuz averaging 2.9 million bpd over the past six days versus 700,000 bpd in August. Reuters also reported Houthi attacks on Riyadh and Yanbu while the US and Iran remain in a stalemate; AP reported the Houthis warned against countries joining Saudi Arabia in Yemen. Brent is $97.49 (-1.81%) and WTI is $94.04 (-2.12%) on Sep 21; JKM CFD is $27.51 (+2.84%) and TTF is 79.52 EUR/MWh (+4.15%) on their latest Sep 18 observations. QatarEnergy force majeure remains reported through November. Crisis level remains 4 (High); probabilities are base 15%, stress 45%, tail 40%.) |
| **Brent** | $97.49 (2026-09-21, Yahoo Finance BZ=F; -1.81%) |
...
| **Exposure trace** | Reuters reported Sep 21 that Saudi exports recovered above 4 million bpd in September and Saudi oil through Hormuz averaged 2.9 million bpd over the past six days versus 700,000 bpd in August. Reuters also reported Houthi attacks on Riyadh and Yanbu while the US and Iran remain in a stalemate; AP reported Sep 20 that the Houthis warned against countries joining Saudi Arabia. QatarEnergy force majeure remains reported through November and no verified signed Hormuz reopening is approved; route-normalised war-risk costs remain unavailable. |
...
- **Brent**: Pre-shock ~$65 -> $126 wartime high intraday (Day 59, Apr 30, CNBC/CNN) -> $97.49 (Sep 21, Yahoo Finance BZ=F; -1.81%) as Saudi exports recover above 4m bpd but Houthi attacks and the US-Iran stalemate keep Hormuz routing risk elevated. Working range $75-85 base; $85-105 stress; $105-135+ tail.
- **JKM LNG**: Baseline $9.5 -> $23.40/MMBtu (Day 20, Reuters/Platts) -> $22.00/MMBtu (Jul 24, Reuters September-delivery assessment) as sustained Hormuz disruption tightened Asian LNG balances; carried at $22.00 pending a newer weekly assessment. Contextual CFD reference $27.51/MMBtu (Trading Economics, Sep 18, rechecked Sep 21), up 2.84%. Reuters reports QatarEnergy is seeking 2-3 MTPA of US LNG through 2031 while force majeure remains through November.
- **TTF Gas**: Pre-shock ~$34/MWh -> 63.58/MWh (Jul 24, MacroMicro) -> 79.52 EUR/MWh (Sep 18, Yahoo Finance TTF=F; +4.15%), the latest approved observation within the three-day freshness window. Saudi export recovery lowers immediate supply pressure, but Houthi attacks and the US-Iran stalemate keep routing risk elevated. No verified commercial Hormuz reopening is approved.
- **Credit**: iTraxx Asia IG est. ~138bp (Aug 5, -2bp); ASEAN HY est. ~475bp (-8bp), both carried pending fresher EM credit data. The scenario split is base 15%, stress 45%, tail 40% as Saudi exports recover but Houthi attacks and the US-Iran stalemate leave Hormuz risk unresolved.
