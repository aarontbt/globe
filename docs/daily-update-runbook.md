...
| **Crisis level** | 4 - High (Aug 30: The previously reviewed Iran-Oman framework for a joint temporary navigational corridor and mine-clearance project remains provisional after a tanker was disabled in an attack off Oman. Reuters said the talks restarted under mounting US sanctions pressure. Brent is $88.10 (-0.47%, Yahoo Finance, Aug 28) and TTF is 66.98 EUR/MWh (-1.89%, Yahoo Finance, Aug 28). Crisis level remains 4 (High); base 10%, stress 60%, tail 30%.) |
...
- **Brent**: Pre-shock ~$65 -> $126 wartime high intraday (Day 59, Apr 30, CNBC/CNN) -> $88.10 (Aug 28, Yahoo Finance BZ=F; -0.47%) as the previously reviewed Iran-Oman corridor talks remained provisional after a tanker was disabled off Oman. Working range $75-85 base (signed workable deal); $78-95 stress (conditional routing); $105-135+ tail (renewed closure).
...
- **TTF Gas**: Pre-shock ~$34/MWh -> 63.58/MWh (Jul 24, MacroMicro) -> 66.98 EUR/MWh (Aug 28, Yahoo Finance TTF=F; -1.89%) as the previously reviewed Iran-Oman corridor talks remained provisional and Qatar LNG force majeure persisted. The marker remains elevated versus the pre-crisis baseline while route and supply risks remain unresolved.
