...
| Field | Value |
|-------|-------|
| **Last updated** | 2026-08-12 (D161) |
| **Crisis level** | 4 - High (Aug 12: The latest reviewed Al Jazeera report (Aug 11) still records Hormuz crossings falling from 15 on Friday to 11 Saturday to 6 Sunday, while Iran and Oman have agreed coordinates for a temporary route but no signed full reopening is confirmed. Trump continues to demand compensation from Iran and claims '100%' US control of the waterway, a claim maritime tracking data does not fully support (Al Jazeera/CNBC, Aug 11). Brent is $89.11, WTI $83.47 and TTF 60.18 EUR/MWh on Aug 12. Crisis level remains 4 (High); tail remains 35% while base remains 10%.) |
| **Brent** | $89.11 (2026-08-12, Yahoo Finance BZ=F; +6.65%) |
...
| **TTF** | 60.18 EUR/MWh (2026-08-12, Yahoo Finance TTF=F; +8.34%) |
| **Exposure trace** | Latest reviewed Al Jazeera report (Aug 11, citing MarineTraffic) records Hormuz crossings falling from 15 on Friday (Aug 7) to 11 Saturday (Aug 8) to 6 Sunday (Aug 9), with 17 vessels routed via the Iran-designated lane and 10 classified undetermined. Iran and Oman have agreed coordinates for a temporary route, but Iran ties full reopening to an end to the US naval blockade and sanctions relief; no signed reopening is confirmed. Trump continues to demand compensation from Iran and claim '100%' US control of the waterway (CNBC/Al Jazeera, Aug 11). Qatar force majeure remains carried through mid-September, current route-normalised freight and war-risk costs remain unavailable. |
...
- **Brent**: Pre-shock ~$65 -> $126 wartime high intraday (Day 59, Apr 30, CNBC/CNN) -> $84.35 (Aug 10 early session, Trading Economics) -> rallied ~4.6% intraday Aug 10 to ~$87-88 on Trump's demand for '50 years' of reparations from Iran (gcaptain, Aug 10) -> $89.11 (Aug 12, +6.7%, Yahoo Finance BZ=F) as the latest reviewed report still showed no signed Hormuz reopening. Working range $75-85 base (signed workable deal); $78-95 stress (conditional routing); $105-135+ tail (renewed closure).
...
- **TTF Gas**: Pre-shock ~$34/MWh -> 63.58/MWh (Jul 24, +2.71% vs Jul 23, MacroMicro) -> 56.34 EUR/MWh (Aug 10 early session, Trading Economics) -> 60.18 EUR/MWh (Aug 12, +8.3%, Yahoo Finance TTF=F) as the latest reviewed report still showed no signed Hormuz reopening. The marker remains elevated versus the pre-crisis baseline while Qatar LNG force majeure and constrained Hormuz traffic persist.
- **Credit**: iTraxx Asia IG est. ~138bp (Aug 5, -2bp); ASEAN HY est. ~475bp (-8bp), both carried pending fresher EM credit data. The scenario split remains base 10%, stress 55%, tail 35% because the latest reviewed report still showed unresolved compensation and reopening terms while MarineTraffic data showed weekend crossings collapsing to just 6; no signed reopening is confirmed.
