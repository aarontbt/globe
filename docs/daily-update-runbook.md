...
| Field | Value |
|-------|-------|
| **Last updated** | 2026-09-04 (D184) |
| **Crisis level** | 4 - High (Sep 4: VP Vance told reporters Sep 3 that Iran's control of the Strait of Hormuz is 'effectively gone,' a 'diminishing asset,' and ruled out talks with Tehran unless it halts attacks on commercial shipping (Time, Washington Times). Kpler data reported by Business Recorder undercut the claim: only ~5 vessels transited Hormuz on Sep 1, versus a 10-day average of ~14, with no liquid tankers among them. Vance also voiced 'extreme skepticism' of Iran's account that a Sep 1 US strike killed 4-5 people at a Kuhestak (Sirik) wedding; Hormozgan officials named four victims, including a 4-year-old, with 60+ wounded (Al Jazeera). No new attacks are reported since Sep 2. Brent held at $95.81 (-0.12%) and WTI at $91.82 (+0.32%) on Sep 3 (Trading Economics); JKM CFD rose to $24.09 (+1.39%, Trading Economics); TTF eased to 71.15 EUR/MWh (-0.92%, Yahoo Finance). QatarEnergy force majeure remains extended into early November. Crisis level holds at 4 (High) given no new attack or Hormuz closure event; probabilities unchanged: base 5%, stress 50%, tail 45%.) |
| **Brent** | $95.81 (2026-09-03, Trading Economics; -0.12%) |
| **JKM** | $22.00/MMBtu (Jul 24, Reuters Sept-delivery assessment, carried; CFD reference $24.09/MMBtu, Trading Economics, Sep 3; QatarEnergy force majeure now reported through early November) |
| **TTF** | 71.15 EUR/MWh (2026-09-03, Yahoo Finance TTF=F; -0.9%) |
| **Exposure trace** | VP Vance said Sep 3 Iran's Hormuz control is 'effectively gone' and ruled out talks unless Tehran halts shipping attacks, but Kpler data show just ~5 Hormuz transits on Sep 1 versus a 10-day average of ~14, undercutting the claim. QatarEnergy force majeure now extends into early November; route-normalised freight and war-risk costs remain unavailable. |
| **Evidence audit** | 17 checked · 12 verified · 5 carried · 0 unsupported · PASS |
...
- **Brent**: Pre-shock ~$65 -> $126 wartime high intraday (Day 59, Apr 30, CNBC/CNN) -> $95.81 (Sep 3, Trading Economics; -0.12%) holding near the post-strike plateau as VP Vance disputes Iran's Hormuz control while Kpler data show traffic still near record lows. Working range $75-85 base (signed workable deal); $85-105 stress (conditional routing); $105-135+ tail (renewed closure).
- **JKM LNG**: Baseline $9.5 -> $23.40/MMBtu (Day 20, Reuters/Platts) -> $22.00/MMBtu (Jul 24, Reuters September-delivery assessment) as sustained Hormuz disruption tightened Asian LNG balances; carried at $22.00 pending a newer weekly assessment. Contextual CFD reference $24.09/MMBtu (Trading Economics, Sep 3), up 1.39%. QatarEnergy force majeure now extends into early November after a further five-cargo notice reported by LNG Industry; 21 of 29 affected cargoes were reported replaced as of Aug 28.
- **TTF Gas**: Pre-shock ~$34/MWh -> 63.58/MWh (Jul 24, MacroMicro) -> 71.15 EUR/MWh (Sep 3, Yahoo Finance TTF=F; -0.92%) easing further as Iran-Oman corridor diplomacy remains conditional and Qatar LNG force majeure persists. The marker remains elevated versus the pre-crisis baseline while route and supply risks remain unresolved.
- **Credit**: iTraxx Asia IG est. ~138bp (Aug 5, -2bp); ASEAN HY est. ~475bp (-8bp), both carried pending fresher EM credit data. The scenario split is base 5%, stress 50%, tail 45% after VP Vance ruled out talks with Iran while Kpler transit data show Hormuz traffic still near record lows despite his claim of restored control.
