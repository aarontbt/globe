...
| Field | Value |
|-------|-------|
| **Last updated** | 2026-09-25 (D205) |
| **Crisis level** | 4 - High (Sep 25: Reuters reported that commodity-vessel transits fell to nine on Sep 24 from 14 the day before, while the 10-day average was 18. Kpler put crude exports at 33.7 million barrels week-to-date. Saudi crude exports through Hormuz are rebounding, but Gulf of Oman ship-to-ship transfer capacity is at its limit. US-Iran talks remain conditional; Reuters said Saudi Yanbu tanker loadings have yet to resume. Brent remains carried at its last accepted Sep 21 quote because current Yahoo and Reuters marks conflict. QatarEnergy force majeure remains reported through November. Crisis level remains 4 (High); probabilities are base 15%, stress 45%, tail 40%.) |
| **Brent** | $97.49 (2026-09-21, Yahoo Finance BZ=F; carried because the Sep 25 Yahoo quote conflicts with its own daily range and Reuters reported $105.11 at 05:41 GMT; instrument reconciliation pending) |
| **JKM** | $22.00/MMBtu (Jul 24, Reuters September-delivery assessment, carried; no newer official assessment approved); JKM-linked CFD $26.38/MMBtu (Trading Economics, Sep 24, +2.55%, market-context reference); QatarEnergy force majeure remains reported through November |
| **TTF** | 75.27 EUR/MWh (2026-09-24, Yahoo Finance TTF=F, +0.22%; latest dated quote); carried after machine refresh failure |
| **Exposure trace** | Reuters reported Sep 25 that commodity-vessel transits fell to nine on Sep 24 from 14, with a 10-day average of 18, while Kpler crude exports were 33.7 million barrels week-to-date. Saudi flows and ship-to-ship demand have surged; talks remain conditional and no verified commercial reopening exists. |
| **Evidence audit** | 24 checked · 14 verified · 10 carried · 0 unsupported · PASS |
...
- **Brent**: Pre-shock ~$65 -> $126 wartime high intraday (Day 59, Apr 30, CNBC/CNN) -> last accepted $97.49 (Sep 21, Yahoo Finance BZ=F; carried). Reuters reported Brent at $105.11 at 05:41 GMT on Sep 25; cache-busted Yahoo returned $99.40 while reporting a $104.91-$106.75 daily range. The discrepancy remains unresolved, so retain the Sep 21 mark pending instrument reconciliation. Working range $75-85 base; $85-105 stress; $105-135+ tail.
- **JKM LNG**: Baseline $9.5 -> $23.40/MMBtu (Day 20, Reuters/Platts) -> official $22.00/MMBtu (Jul 24, Reuters September-delivery assessment, carried; no newer official assessment found). The JKM-linked CFD reference is $26.38/MMBtu (Trading Economics, Sep 24, +2.55%), contextual and not the official assessment. Reuters Sep 11 reported QatarEnergy is seeking 2-3 MTPA of US LNG through 2031 while force majeure remains reported through November.
- **TTF Gas**: Pre-shock ~$34/MWh -> 63.58/MWh (Jul 24, MacroMicro) -> 75.27 EUR/MWh (Sep 24, Yahoo Finance TTF=F; +0.22%), latest dated quote. Saudi exports through Hormuz are rebounding but tanker and transfer congestion remain; no verified commercial reopening is approved.
- **Credit**: iTraxx Asia IG est. ~138bp and ASEAN HY est. ~475bp (Aug 5), both carried as estimates pending fresher EM credit data. No current daily source-approved credit marks are available. The scenario split remains base 15%, stress 45%, tail 40% while no signed reopening has been verified.
